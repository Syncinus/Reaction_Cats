...
//	}
	...
	*/
	...
	public void AddCat(Cat CatToRecieve, NetworkInstanceId netInstanceId) {
		...
		foreach (Ability thatAbility in CatToRecieve.abilitys) {
			PackagedDataList.Add (thatAbility.Name);
		}
		String[] PackagedData = PackagedDataList.ToArray ();
		CmdAddCat (CatDefense, CatAttack, CatTorsoHP, CatMaxSpeed, TheCatName, CatTravelSpeed, CatMaxStamina, CatAttackSpeed, CatAttackRecharge, PackagedData, netInstanceId);
	}
