...
public class Hex : NetworkBehaviour {
	...
	public static int interactrowid;
	public static int interactnumid;
	...
	void OnMouseEnter() {
		...
		if (playerscript != null) {
			...
			if (playerscript.CATINTERACTING == true && forceseter == false) {
				rend.color = new Color32 (170, 32, 64, 255);
				seter = true;
				overhex = true;
			}
		}
	...
	public void OnMouseDown() {
		...
		if (playerscript != null) {
			...
			//if (playerscript.MOVINGCAT == true || playerscript.CATJUMPING == true) {
				hexrowid = rowid;			
				hexnumid = numberid;
            Debug.Log("Hex Was Clicked When Playerscript Was Not Null!");
			//}
			if (playerscript.CATINTERACTING == true) {
				interactrowid = rowid;
				interactnumid = numberid;
				playerscript.interacthexrow = playerscript.currenthexrow;
				playerscript.interacthexnum = playerscript.currenthexnum;
				playerscript.interactBlocker = false;
			}
...
////		}
    ...
    public void Update()
    {
		...
		if (playerscript != null) {
			...
			if (playerscript.hexes.Contains (thisishex) && forceseter == false) {
				rend.color = new Color32 (255, 0, 185, 255);
				rend.sprite = selectedForMoveSprite;
			} else {
			...
			if (playerscript.interactinghexes.Contains (thisishex) && forceseter == false) {
				rend.color = new Color32 (142, 87, 123, 255);
			}
		}
    }
